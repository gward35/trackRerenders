parcelRequire = (function (e, r, t, n) {
...
})(
  {
    ...
    M7E5: [
      ...
      { lodash: "HJaA", "react-fast-compare": "DdNx" },
    ],
    fBsl: [
      function (require, module, exports) {
        "use strict"
          ...
          n = function (n) {
            ...
            switch (n.type) {
              ...
              case e.DIFF_TYPES.EQUAL:
                o(l + ": Value did not change. Avoidable re-render!"),
    ...
    NDHn: [
      function (require, module, exports) {
        ...
        var i = function (e) {
            return r.isString(e) ? new RegExp("^" + e + "$") : e
          },
          u = function (e) {
            return e ? [].concat(e) : []
          },
          p = {
            ...
            groupByComponent: !0,
            collapseComponentGroups: !0,
            defaultNotifier: n.notifier,
          }
        exports.normalizeOptions = function (e) {
          ...
          var t = e.include,
            ...
            r = e.exclude,
            s = void 0 === r ? [exports.DEFAULT_EXCLUDE] : r,
            a = e.groupByComponent,
            l = void 0 === a || a,
            c = e.collapseComponentGroups,
            d = void 0 === c || c,
            f = e.defaultNotifier
          return {
            defaultNotifier: void 0 === f ? n.notifier : f,
            include: u(o).map(i),
            exclude: u(s).map(i),
            groupByComponent: l,
            collapseComponentGroups: d,
          }
        }
      },
      { lodash: "HJaA", "./notifier": "ldiQ" },
    ],
    eOLe: [
      function (require, module, exports) {
        "use strict"
        ...
        exports.shouldInclude = function (e, u) {
          return (
            t.default.some(u.include, function (t) {
              return t.test(e)
            }) &&
            !t.default.some(u.exclude, function (t) {
              return t.test(e)
            })
          )
        }
    ...
    B6dB: [
      function (require, module, exports) {
          ...
          e =
            ...
            function () {
              ...
              var n = Array(t),
                o = 0
              for (e = 0; e < r; e++)
                for (var i = arguments[e], p = 0, a = i.length; p < a; p++, o++)
                  n[o] = i[p]
              return n
            }
        Object.defineProperty(exports, "__esModule", { value: !0 }),
        ...
        var r = require("./diff"),
          n = require("./getDisplayName"),
          o = require("./normalizeOptions"),
          i = require("./shouldInclude"),
          p = function (t, e, r) {
        ...
        function a(t, e) {
          return function (n, o) {
            var i = r.classifyDiff(n, this.props, t + ".props")
            if (i.type !== r.DIFF_TYPES.UNAVOIDABLE) {
              var p = r.classifyDiff(o, this.state, t + ".state")
              p.type !== r.DIFF_TYPES.UNAVOIDABLE &&
                e.defaultNotifier(
                  e.groupByComponent,
        ...
        var u = function (e, r, n) {
            var o = a(r, n),
              i = (function (r) {
                ...
                return (
                  t(n, r),
                  (n.prototype.componentDidUpdate = function (t, r, n) {
                    o.call(this, t, r),
                      "function" == typeof e.prototype.componentDidUpdate &&
                        e.prototype.componentDidUpdate.call(this, t, r, n)
                  }),
                  n
                )
              })(e),
              p = Object.getOwnPropertyDescriptor(i, "displayName")
            return (
              (!i.displayName || (p && p.writable)) && (i.displayName = r), i
            )
          },
          s = function (e, r, n) {
            var o = a(r, n),
              ...
              u = (function (r) {
                ...
                return (
                  t(n, r),
                  (n.prototype.function = function (t, r) {
                    return (
                      o.call({ props: t, state: p }, i, p), (i = t), new e(t, r)
                    )
                  }),
                  n
                )
              })(e)
            return (u.displayName = r), (u.contextTypes = e.contextTypes), u
          }
        ;(exports.trackReRenders = function (t, r) {
          r = o.normalizeOptions(r)
          ...
          return (
            (t.createElement = function (o) {
              for (var f = [], l = 1; l < arguments.length; l++)
                f[l - 1] = arguments[l]
              var y = o,
                d = n.getDisplayName(y)
              return (
                "function" == typeof y &&
                  i.shouldInclude(d, r) &&
                  (y =
                    y.prototype && "function" == typeof y.prototype.render
                      ? p(c, y, function () {
                          return u(y, d, r)
                        })
                      : p(c, y, function () {
            ...
            (t.__TRACK_RERENDERS__ = function () {
              ;(t.createElement = a), delete t.__TRACK_RENDERS__
            }),
            t
          )
        }),
    ...
    dBI9: [
      function (require, module, exports) {
        ...
        var y = function () {
            return t.default.createElement("div", null, "Track Rerenders")
          },
          b = (function (e) {
    ...
    XJdW: [
      function (require, module, exports) {
        ...
        ;(0, r.default)(e.default)
        var d = { b: "b" }
        console.info("First Render (does not trigger trackReRenders)."),
          (0, t.render)(
            e.default.createElement(n.default, { a: 1, b: d }),
          ...
          (0, t.render)(
            e.default.createElement(n.default, { a: 1, b: { b: "b" } }),
            document.getElementById("root")
          ),
          console.info(
          ...
          (0, t.render)(
            e.default.createElement(n.default, { a: 1, fn: function () {} }),
            document.getElementById("root")
          ),
...
//# sourceMappingURL=/demo.6d8104d0.js.map
