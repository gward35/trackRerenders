 ...
 */
    ...
    "diff.ts": [
      function (require, module, exports) {
        ...
        var react_fast_compare_1 = __importDefault(
        ...
        exports.classifyDiff = function (prev, next, name) {
          if (prev === next) {
            return {
          ...
          var isChanged = function isChanged(key) {
            return prev[key] !== next[key] && !_.isEqual(prev[key], next[key])
          }
          ...
          var keys = _.union(_.keys(prev), _.keys(next))

          var changedKeys = _.filter(keys, isChanged)
    ...
    "getDisplayName.ts": [
      function (require, module, exports) {
        ...
        exports.getDisplayName = function (ctor) {
    ...
    "notifier.ts": [
      function (require, module, exports) {
        ...
        var notifyDiff = function notifyDiff(p) {
          var name = p.name,
            prev = p.prev,
            next = p.next,
            type = p.type
          ...
          switch (type) {
            ...
            case diff_1.DIFF_TYPES.EQUAL:
              consoleWarn(
                "".concat(name, ": Value did not change. Avoidable re-render!")
              )
              ...
              if (prev && next) {
                Object.keys(prev).forEach(function (key) {
                  if (prev[key] !== next[key]) {
                    console.log(
                      '"' + key + '" property is not equal by reference'
                    )
                  }
                })
              }
    ...
    "normalizeOptions.ts": [
      function (require, module, exports) {
        ...
        var toRegExp = function toRegExp(s) {
          return _.isString(s) ? new RegExp("^".concat(s, "$")) : s
        }
        ...
        exports.normalizeOptions = function (options) {
          var _options$include = options.include,
            include =
              _options$include === void 0
                ? [exports.DEFAULT_INCLUDE]
                : _options$include,
            _options$exclude = options.exclude,
            exclude =
              _options$exclude === void 0
                ? [exports.DEFAULT_EXCLUDE]
                : _options$exclude,
            _options$groupByCompo = options.groupByComponent,
            groupByComponent =
              _options$groupByCompo === void 0 ? true : _options$groupByCompo,
            _options$collapseComp = options.collapseComponentGroups,
            collapseComponentGroups =
              _options$collapseComp === void 0 ? true : _options$collapseComp,
            _options$defaultNotif = options.defaultNotifier,
            defaultNotifier =
              _options$defaultNotif === void 0
                ? notifier_1.notifier
                : _options$defaultNotif
          return {
    ...
    "shouldInclude.ts": [
      function (require, module, exports) {
        ...
        exports.shouldInclude = function (displayName, options) {
          return (
            _.some(options.include, function (r) {
              return r.test(displayName)
            }) &&
            !_.some(options.exclude, function (r) {
              return r.test(displayName)
            })
          )
        }
    ...
    "index.ts": [
      function (require, module, exports) {
        ...
        var shouldInclude_1 = require("./shouldInclude")
        ...
        function createComponentDidUpdate(displayName, options) {
          return function componentDidUpdate(prevProps, prevState) {
            var propsDiff = diff_1.classifyDiff(
              prevProps,
              this.props,
            ...
            var stateDiff = diff_1.classifyDiff(
              prevState,
              this.state,
              "".concat(displayName, ".state")
            )
        ...
        var createClassComponent = function createClassComponent(
          ctor,
          displayName,
          options
        ) {
          var cdu = createComponentDidUpdate(displayName, options) // the wrapper class extends the original class,
          ...
          var TRRClassComponent = /*#__PURE__*/ (function (_ctor) {
            _inherits(TRRClassComponent, _ctor)

            var _super = _createSuper(TRRClassComponent)

            function TRRClassComponent() {
              _classCallCheck(this, TRRClassComponent)

              return _super.apply(this, arguments)
            }

            _createClass(TRRClassComponent, [
              {
        ...
        var createFunctionalComponent = function createFunctionalComponent(
          ...
          var cdu = createComponentDidUpdate(displayName, options)
          var previousProps = {}
          var state = {}

          var TRRClassComponent = /*#__PURE__*/ (function (_ctor2) {
            _inherits(TRRClassComponent, _ctor2)

            var _super2 = _createSuper(TRRClassComponent)
            ...
            _createClass(TRRClassComponent, [
              {
                key: "function",
                value: function _function(props, context) {
                  cdu.call(
                    {
                      props: props,
                      state: state,
        ...
        exports.trackReRenders = function (React, options) {
          options = normalizeOptions_1.normalizeOptions(options) // Store the original `React.createElement`,
          ...
          React.createElement = function (type) {
            var ctor = type
            var displayName = getDisplayName_1.getDisplayName(ctor) // the element is a class component or a functional component
            ...
            if (
              ...
              if (
                ...
                ctor = memoized(memo, ctor, function () {
                  return createClassComponent(ctor, displayName, options)
                })
              } else {
                // If the constructor function has no `render`,
                // it must be a simple functioanl component.
                ctor = memoized(memo, ctor, function () {
                  return createFunctionalComponent(ctor, displayName, options)
                })
              }
          ...
          React.__TRACK_RERENDERS__ = function () {
      ...
      {
        "./diff": "diff.ts",
        "./getDisplayName": "getDisplayName.ts",
        "./normalizeOptions": "normalizeOptions.ts",
        "./shouldInclude": "shouldInclude.ts",
      },
    ],
